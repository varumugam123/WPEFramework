...
public:
    ...
    ITestUtility::ICommand::IIterator * Commands() const override
    {
        ...
        ASSERT((output != nullptr) && "Failed to get ITestUtility::ICommand::IIterator proxy (TestUtilityProxy::Commands() proxy stub)");
    ...
    ITestUtility::ICommand * Command(const string & param0) const override
    {
        ...
        ASSERT((output != nullptr) && "Failed to get ITestUtility::ICommand proxy (TestUtilityProxy::Command() proxy stub)");
...
public:
    ...
    ITestUtility::ICommand * Command() const override
    {
        ...
        ASSERT((output != nullptr) && "Failed to get ITestUtility::ICommand proxy (TestUtilityCommandIteratorProxy::Command() proxy stub)");
